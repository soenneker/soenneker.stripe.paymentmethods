...
public sealed class StripePaymentMethodsUtil : IStripePaymentMethodsUtil
{
    ...
    {
        PaymentMethodService service = await _service.Get(cancellationToken)
                                                     .NoSync();
    ...
    {
        IAsyncEnumerable<PaymentMethod>? response = (await _service.Get(cancellationToken)
                                                                   .NoSync()).ListAutoPagingAsync(cancellationToken: cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IAsyncEnumerable<PaymentMethod>? response = (await _service.Get(cancellationToken)
                                                                   .NoSync()).ListAutoPagingAsync(options: options, cancellationToken: cancellationToken);
    ...
    public async ValueTask<PaymentMethod?> GetFirstByUserIdAndType(string userId, StripePaymentMethodType type, CancellationToken cancellationToken = default)
    {
        ...
        PaymentMethodService service = await _service.Get(cancellationToken)
                                                     .NoSync();
        StripeList<PaymentMethod>? list = await service.ListAsync(options, cancellationToken: cancellationToken)
                                                       .NoSync();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await service.UpdateAsync(paymentMethodId, options, requestOptions, cancellationToken)
                            .NoSync();
    }
    ...
    public async ValueTask<PaymentMethod?> Get(string paymentMethodId, PaymentMethodGetOptions? options = null, RequestOptions? requestOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await (await _service.Get(cancellationToken)
                                    .NoSync()).GetAsync(paymentMethodId, options, requestOptions, cancellationToken: cancellationToken)
                                              .NoSync();
    }
    ...
    public async ValueTask Delete(string paymentMethodId, PaymentMethodDetachOptions? options = null, RequestOptions? requestOptions = null,
        CancellationToken cancellationToken = default)
    {
        await (await _service.Get(cancellationToken)
                             .NoSync()).DetachAsync(paymentMethodId, options, requestOptions, cancellationToken: cancellationToken)
                                       .NoSync();
    }
    ...
    {
        await (await _service.Get(cancellationToken)
                             .NoSync()).AttachAsync(paymentMethodId, options, requestOptions, cancellationToken: cancellationToken)
                                       .NoSync();
    }
